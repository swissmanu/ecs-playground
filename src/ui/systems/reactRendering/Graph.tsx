  ...
  return (
    <g>
      {edges.map(([from, to], i) => (
        <line
          key={i}
          x1={from.Position.top * cellSize + cellSize / 2}
          y1={from.Position.left * cellSize + cellSize / 2}
          x2={to.Position.top * cellSize + cellSize / 2}
          y2={to.Position.left * cellSize + cellSize / 2}
          stroke="blue"
          strokeWidth={6}
        />
      ))}
