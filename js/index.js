...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // src/simulation/entityManager/component.ts
  var Component = class {
    constructor(typeTag) {
  ...
  // src/simulation/components/consumer.ts
  var _ConsumerComponent = class extends Component {
    constructor() {
      super(_ConsumerComponent.TypeTag);
    }
  };
  var ConsumerComponent = _ConsumerComponent;
  ConsumerComponent.TypeTag = "Consumer";

  // src/simulation/components/graphNode.ts
  var _GraphNodeComponent = class extends Component {
    constructor(edges = []) {
      super(_GraphNodeComponent.TypeTag);
      this.edges = edges;
      edges.forEach(({ data, target }) => target.edges = [...target.edges, { target: this, data }]);
    }
  };
  var GraphNodeComponent = _GraphNodeComponent;
  GraphNodeComponent.TypeTag = "GraphNode";

  // src/simulation/components/position.ts
  var _PositionComponent = class extends Component {
    constructor(left, top) {
      super(_PositionComponent.TypeTag);
      this.left = left;
      this.top = top;
    }
  };
  var PositionComponent = _PositionComponent;
  PositionComponent.TypeTag = "Position";

  // src/simulation/components/producer.ts
  var _ProducerComponent = class extends Component {
    constructor(productivity = 1, progress = 0) {
      super(_ProducerComponent.TypeTag);
      this.productivity = productivity;
      this.progress = progress;
    }
  };
  var ProducerComponent = _ProducerComponent;
  ProducerComponent.TypeTag = "Producer";

  // src/simulation/components/store.ts
  var _StoreComponent = class extends Component {
    constructor() {
      super(_StoreComponent.TypeTag);
      this.storedItems = 0;
    }
  };
  var StoreComponent = _StoreComponent;
  StoreComponent.TypeTag = "Store";

  // src/simulation/components/walker.ts
  var _WalkerComponent = class extends Component {
    constructor(state, speed = 1) {
      super(_WalkerComponent.TypeTag);
      this.state = state;
      this.speed = speed;
    }
  };
  var WalkerComponent = _WalkerComponent;
  WalkerComponent.TypeTag = "Walker";
  ...
  // src/simulation/entityManager/entityManager.ts
  var EntityManager = class {
    ...
    addEntity(...components) {
      ...
      for (const component of components) {
        ...
        componentMap[component.typeTag] = component;
      }
    ...
    getEntitiesWithComponent(...typeTag) {
      const entities = [];
      for (const [id, components] of this.entities) {
        if (typeTag.every((t) => components[t] !== void 0)) {
          entities.push([id, components]);
        }
      }
      return entities;
    }
    getEntityWithComponents(id, ...typeTag) {
  ...
  // src/algorithm/graph/astar/astar.ts
  var import_heap = __toESM(require_heap2());
  function findPath(start, goal, getEdges, getVertex, calculateCost, heuristic) {
    var _a, _b;
    const frontier = new import_heap.default(([a], [b]) => a - b);
    frontier.insert([0, start]);
    const cameFrom = /* @__PURE__ */ new Map([[start, null]]);
    const costSofar = /* @__PURE__ */ new Map([[start, 0]]);
    while (!frontier.empty()) {
      ...
      for (const edge of getEdges(currentVertex)) {
        ...
        const newCost = ((_a = costSofar.get(currentVertex)) != null ? _a : 0) + calculateCost(currentVertex, edge);
        if (!costSofar.has(next) || newCost < ((_b = costSofar.get(next)) != null ? _b : 0)) {
  ...
  // src/algorithm/graph/astar/heuristics/djikstra.ts
  function djikstraHeuristic(from, to, cost) {
    return cost;
  }

  // src/simulation/system.ts
  var System = class {
  ...
  // src/simulation/systems/logistics.ts
  var LogisticsSystem = class extends System {
    update() {
      for (const [, components] of this.entityManager.getEntitiesWithComponent("Walker")) {
        if (components.Walker.state.type === "Idle") {
          ...
          const hasConsumer = this.entityManager.getEntityWithComponents(components.Walker.state.location.entityId, "Consumer") !== null;
          const [to] = hasConsumer ? this.entityManager.getEntitiesWithComponent("Producer", "Store", "GraphNode") : this.entityManager.getEntitiesWithComponent("Consumer", "Store", "GraphNode");
          if (from && to) {
            const path = findPath(from, to[1].GraphNode, ({ edges }) => edges, ({ target }) => target, (_, { data }) => data, djikstraHeuristic);
            const edgePath = path.reduce((acc, x, i) => {
              if (i === 0) {
                return acc;
              }
  ...
  // src/simulation/systems/production.ts
  var ProductionSystem = class extends System {
    update() {
  ...
  // src/ui/systems/reactRendering/reactRendering.ts
  var import_react6 = __toESM(require_react());
  var import_react_dom = __toESM(require_react_dom());

  // src/ui/systems/reactRendering/ReactRenderer.tsx
  var import_react5 = __toESM(require_react());

  // src/ui/systems/reactRendering/Entity.tsx
  var import_react = __toESM(require_react());
  var Entity = ({ id, cellSize, onClick }) => {
    const onClickRect = import_react.default.useCallback((e) => {
      if (onClick) {
        e.preventDefault();
        onClick();
      }
    ...
    return /* @__PURE__ */ import_react.default.createElement("g", {
      ...
      fill: "brown",
      onClick: onClickRect
    }), /* @__PURE__ */ import_react.default.createElement("text", null, id));
  };
  var Entity_default = Entity;

  // src/ui/systems/reactRendering/Graph.tsx
  var import_react2 = __toESM(require_react());

  // src/algorithm/graph/explore.ts
  function explore(start) {
    const nodes = /* @__PURE__ */ new Set();
    const edges = [];
    const work = [start];
    let from;
    while ((from = work.pop()) !== void 0) {
      nodes.add(from);
  ...
  // src/ui/util/vector/add.ts
  function add([ax, ay], [bx, by]) {
    return [ax + bx, ay + by];
  }

  // src/ui/util/vector/multiplyWithScalar.ts
  function multiplyWithScalar([x, y], s) {
    return [x * s, y * s];
  }

  // src/ui/util/vector/positionAsVector.ts
  function positionAsVector(position) {
    return [position.left, position.top];
  }

  // src/ui/util/vector/subtract.ts
  function subtract([ax, ay], [bx, by]) {
    return [ax - bx, ay - by];
  }

  // src/ui/systems/reactRendering/Graph.tsx
  var Graph = ({ entityManager, cellSize }) => {
    const edges = import_react2.default.useMemo(() => {
      const [first] = entityManager.getEntitiesWithComponent("GraphNode");
      if (first) {
        const { edges: edges2 } = explore(first[1].GraphNode);
        return edges2;
      }
      return [];
    }, [entityManager]);
    const positions = import_react2.default.useMemo(() => edges.reduce((acc, [{ entityId: fromId }, { entityId: toId }, data]) => {
    ...
    return /* @__PURE__ */ import_react2.default.createElement("g", null, positions.map(([from, to, data], i) => {
  ...
  // src/ui/systems/reactRendering/Grid.tsx
  var import_react3 = __toESM(require_react());
  var Grid = ({ numberOfCells: [horizontally, vertically], cellSize, children }) => {
    const [width, height] = import_react3.default.useMemo(() => [horizontally * cellSize, vertically * cellSize], []);
    return /* @__PURE__ */ import_react3.default.createElement("svg", {
      width: width + 2,
      height: height + 2
    }, /* @__PURE__ */ import_react3.default.createElement("g", {
      transform: "translate(1,1)"
    }, /* @__PURE__ */ import_react3.default.createElement("g", null, Array.from(new Array(horizontally + 1)).map((_, i) => /* @__PURE__ */ import_react3.default.createElement("line", {
      key: i,
      x1: 0,
      y1: i * cellSize,
      x2: width,
    ...
    })), Array.from(new Array(vertically + 1)).map((_, i) => /* @__PURE__ */ import_react3.default.createElement("line", {
      key: i,
      x1: i * cellSize,
      y1: 0,
      x2: i * cellSize,
      y2: height,
      style: { stroke: "lightgray" }
    }))), /* @__PURE__ */ import_react3.default.createElement("g", null, children)));
  };
  var Grid_default = Grid;

  // src/ui/systems/reactRendering/Walker.tsx
  var import_react4 = __toESM(require_react());

  // src/ui/util/vector/asSVGTranslate.ts
  function asSVGTranslate([x, y]) {
    return `translate(${x}, ${y})`;
  }

  // src/ui/systems/reactRendering/Walker.tsx
  var Walker = ({ state, cellSize, onClick, entityManager }) => {
    const onClickCircle = import_react4.default.useCallback((e) => {
      if (onClick) {
        e.preventDefault();
        onClick();
      }
    ...
    switch (state.type) {
      case "Idle": {
        ...
        return /* @__PURE__ */ import_react4.default.createElement("g", {
          transform: `translate(${position.Position.left * cellSize}, ${position.Position.top * cellSize})`
      ...
      case "Moving": {
        const segmentStart = state.currentPathSegment === 0 ? entityManager.getEntityWithComponents(state.start.entityId, "Position") : entityManager.getEntityWithComponents(state.path[state.currentPathSegment - 1].target.entityId, "Position");
        const segmentEnd = entityManager.getEntityWithComponents(state.path[state.currentPathSegment].target.entityId, "Position");
        ...
        return /* @__PURE__ */ import_react4.default.createElement("g", {
          transform: asSVGTranslate(absolute)
        }, /* @__PURE__ */ import_react4.default.createElement("circle", {
          cx: cellSize / 2,
          cy: cellSize / 2,
          r: cellSize / 4,
  ...
  var Walker_default = Walker;

  // src/ui/systems/reactRendering/ReactRenderer.tsx
  var CELL_SIZE = 50;
  var ReactRenderer = ({ entityManager, onSimulateOneTick, onToggleSimulation }) => {
    const positions = import_react5.default.useMemo(() => entityManager.getEntitiesWithComponent("Position"), [entityManager]);
    const walkers = import_react5.default.useMemo(() => entityManager.getEntitiesWithComponent("Walker"), [entityManager]);
    const [selectedEntityId, selectEntityId] = import_react5.default.useState(null);
    const onClickSimulateOneTick = import_react5.default.useCallback(() => {
      onSimulateOneTick();
    }, [onSimulateOneTick]);
    const onClickToggleSimulation = import_react5.default.useCallback(() => {
      onToggleSimulation();
    }, [onToggleSimulation]);
    return /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, /* @__PURE__ */ import_react5.default.createElement("header", {
      ...
      onClick: onClickToggleSimulation
    }, "Toggle"), /* @__PURE__ */ import_react5.default.createElement("button", {
      onClick: onClickSimulateOneTick
    }, "Step")), /* @__PURE__ */ import_react5.default.createElement("main", {
      style: { display: "flex", gap: 16 }
    }, /* @__PURE__ */ import_react5.default.createElement(Grid_default, {
      numberOfCells: [10, 10],
      cellSize: CELL_SIZE
    }, /* @__PURE__ */ import_react5.default.createElement(Graph_default, {
      entityManager,
      cellSize: CELL_SIZE
    }), positions.map(([id, components]) => /* @__PURE__ */ import_react5.default.createElement("g", {
      key: id,
      transform: `translate(${components.Position.left * CELL_SIZE}, ${components.Position.top * CELL_SIZE})`
    }, /* @__PURE__ */ import_react5.default.createElement(Entity_default, {
      id,
      components,
      cellSize: CELL_SIZE,
      onClick: () => selectEntityId(id)
    }))), walkers.map(([id, components]) => /* @__PURE__ */ import_react5.default.createElement(Walker_default, {
      key: id,
      state: components.Walker.state,
      cellSize: CELL_SIZE,
      entityManager,
      onClick: () => selectEntityId(id)
    }))), selectedEntityId && /* @__PURE__ */ import_react5.default.createElement("pre", null, JSON.stringify(entityManager.getEntity(selectedEntityId), getCircularReplacer(), 2))));
  };
  ...
  // src/ui/systems/reactRendering/reactRendering.ts
  var ReactRenderingSystem = class extends System {
    constructor(entityManager, root, onSimulateOneTick, onToggleSimulation) {
      super(entityManager);
      this.root = root;
      this.onSimulateOneTick = onSimulateOneTick;
      this.onToggleSimulation = onToggleSimulation;
    }
    update() {
      import_react_dom.default.render(import_react6.default.createElement(ReactRenderer_default, {
  ...
  function createSimulation() {
    ...
    const entityA = entityManager.addEntity(nodeA, new ProducerComponent(0.5), new StoreComponent(), new PositionComponent(1, 1));
    const entityB = entityManager.addEntity(nodeB, new PositionComponent(1, 3));
    const entityC = entityManager.addEntity(nodeC, new ConsumerComponent(), new StoreComponent(), new PositionComponent(5, 4));
    const entityD = entityManager.addEntity(nodeD, new PositionComponent(4, 2));
    entityManager.addEntity(new WalkerComponent({
      type: "Idle",
      location: entityManager.getEntityWithComponents(entityC, "GraphNode").GraphNode
    }, 2));
    const systems = [new LogisticsSystem(entityManager), new ProductionSystem(entityManager)];
    return {
      entityManager,
      systems
    };
